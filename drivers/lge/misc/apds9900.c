...
#if 0////20121221/kyuhak.choi/als sensor bug from hw
#if 1//20121211/kyuhak.choi/als sensor bug from hw
...
#else
	APDS_IAC1 = cdata - (data->coeff_b*irdata)/100;
	APDS_IAC2 = (data->coeff_c*cdata)/100 - (data->coeff_d*irdata)/100;
	
	if(APDS_IAC2 < 0 || APDS_IAC2 >= 42949672)
		APDS_IAC = 0;
	else
		APDS_IAC = APDS_IAC1>APDS_IAC2?APDS_IAC1:APDS_IAC2;
