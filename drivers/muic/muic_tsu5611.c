...
//                                               
		...
		{
		        printk(" max8971_start_charging TA\n");
		...
		{
		        printk("max8971_start_charging USB\n");
		...
		else if( muic_mode == MUIC_CP_USB )
		{
		 //printk("[MUIC] max8971_stop due to MUIC_CP_USB mode \n");
		        printk("max8971_start_charging Factory MUIC_CP_USB \n");
		        // max8971_start_charging(1550);
		...
		{
		         printk("max8971_start_charging Factory MUIC_CP_UART \n");
	        ...
	        {
	                printk("max8971_start_charging MHL\n");
	                max8971_start_charging(400);
	        }
	        else if( muic_mode == MUIC_NONE)
	        {
	                printk("max8971_stop_charging\n");
	                max8971_stop_charging();
		}
		else
		       printk("can not open charger mode\n");
		//                                               
#endif
	return ret;
}
